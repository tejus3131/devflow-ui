...
const StatsCard: React.FC<StatsCardProps> = ({ title, value, icon, state, error }) => {
    ...
    return (
        <div className="bg-neutral-light dark:bg-neutral-dark border border-neutral-dark/20 dark:border-border-dark p-5 rounded-xl transition-colors shadow-sm flex justify-between items-center">
